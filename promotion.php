...
<tr>
    ...
    <td>
                                                ...
                                                <input  name="idp" type="text" class="form-control" aria-required="true" aria-invalid="false">
                                            </td>
...
<tr>
    ...
    <td>
                                                ...
                                                <input  name="IDPR" type="text" class="form-control" aria-required="true" aria-invalid="false">
                                            </td>
...
<tr>
    ...
    <td>
                                                ...
                                                <input  name="date1" type="date" class="form-control" aria-required="true" aria-invalid="false">
                                            </td>
...
<tr>
    ...
    <td>
                                                ...
                                                <input  name="date2" type="date" class="form-control" aria-required="true" aria-invalid="false">
                                            </td>
...
<td> <button  type="submit" class="btn btn-lg btn-info btn-block" value="Ajouter" ></td>
...
echo'
    ...
    <form action="supp.php" method="POST">
      <button  type="submit" class="btn btn-lg btn-info btn-block" value="Supprimer" > 
